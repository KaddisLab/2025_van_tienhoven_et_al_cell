#' Collate Cell Annotations from Multiple Sources
#'
#' Combines cell annotations from multiple CSV files or data frames into a single
#' data frame. Files are merged on the 'cell' column using left joins.
#'
#' @param ... CSV file paths or data frames containing cell annotations.
#'           Each source must have a 'cell' column for joining.
#'
#' @return A data frame containing merged cell annotations from all sources
#' 
#' @import dplyr
