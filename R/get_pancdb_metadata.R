#' Retrieve and Process PANC-db Metadata
#'
#' Reads and processes donor and scRNA-seq metadata from PANC-db Excel files.
#' Combines donor information with sequencing metadata and performs standardized
#' cleaning and categorization of key variables.
#'
#' @return A data frame containing processed metadata with standardized columns:
#'   - donor_id/sample_id/sample_name: Unified sample identifiers
#'   - diabetes_status: Categorized as "T1DM", "T2DM", "AABP", or "NODM"
#'   - technology: Sequencing technology (10XV2, 10XV3, etc.)
#'   - sample_race: Standardized race categories (AFA, CAU, HIS)
#'   - batch: Integer batch identifier
#'   - tissue_source: Source institution (UPenn or nPod)
#'   - Additional clinical and technical metadata columns
#'
