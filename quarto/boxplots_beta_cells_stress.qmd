...
---
title: "Beta cells: ER Genes stress score"
date: "2024-5-15" 
...
er_expression <- seurat_object %>%
    ...
    FetchData(vars = c("orig.ident", "protected", "er_stress_score", "upr_score"), layer = "data") |>
    pivot_longer(
        cols = -c(protected, orig.ident),
        names_to = "gene",
