...
total_endocrine_cells_per_donor <- seurat_object |>
    dplyr::filter(cell_type %in% c("Alpha", "Beta", "Delta", "Gamma", "Epsilon")) |>
...
seurat_object <- seurat_object |>
    ...
    Seurat::SCTransform(vst.flavor = "v2", vars.to.regress = c("batch"), verbose = FALSE) |>
    Seurat::RunPCA(verbose = FALSE) |>
    harmony::RunHarmony(group.by.vars = "batch", ncores = cpus, verbose = FALSE) |>
