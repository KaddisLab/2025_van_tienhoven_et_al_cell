...
#| fig-height: 12
#| fig-width: 4
scCustomize::Stacked_VlnPlot(seurat_object, features = cell_type_markers, x_lab_rotate = TRUE, colors_use = custom_palette, group.by = "hpap_celltype") & labs(title = "HPAP")
```
