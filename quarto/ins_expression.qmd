...
# Fetch control genes
control_genes <- c("SLC11A2", "SLC40A1", "UBC", "RPLP0")
control_genes_hk <- normalize_control_genes(seurat_object, control_genes, housekeeping_genes)

data <- seurat_object[[]] |>
    tibble::rownames_to_column(var = "cell") |>
    dplyr::select(cell, orig.ident, INS_hk, rs3842752_consensus, protected, cell_type, contains("stress")) |>
...
downloadthis::download_this(
    ...
    button_label = "Download stress scores",
    button_type = "success",
    has_icon = TRUE,
    icon = "fa fa-save"
)
