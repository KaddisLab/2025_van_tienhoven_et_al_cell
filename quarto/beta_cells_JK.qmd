...
dplyr::filter(cell_type == "Beta") |>
    #Seurat::SCTransform(vst.flavor = "v2", vars.to.regress = c("batch"), verbose = TRUE) |>
    Seurat::RunPCA(verbose = FALSE) |>
    harmony::RunHarmony(group.by.vars = "orig.ident", ncores = cpus, verbose = TRUE) |>
    Seurat::FindNeighbors(reduction = "harmony", verbose = TRUE) |>
    Seurat::FindClusters(resolution = 0.1, method = "igraph", verbose = TRUE) |>
    Seurat::RunUMAP(reduction = "harmony", dims = 1:30, verbose = TRUE)
```
