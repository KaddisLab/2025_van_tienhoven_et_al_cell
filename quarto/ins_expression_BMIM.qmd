---
title: "INS expression: BMIM controls"
date: "2024-7-11" 
...
# Fetch control genes
control_genes <- c("SLC11A2", "SLC40A1", "UBC", "RPLP0", "ERN1", "TBP", "ACTB", "GAPDH", "PGK1", "TUBB", "PPIA", "SDHA", "TFRC", "GUSB", "HMBS", "HPRT1")
...
## Beta cell INS expression & Cellular stress score
...
data |>
    ...
    geom_point() +
    labs(title = "INS_hk vs cellular_stress_score", y = "cellular_stress_score", x = "INS_hk") +
    theme_classic() +
    Seurat::NoLegend() +
...
Signature genes: `r signatures$cellular_stress`
...
all_data |>
downloadthis::download_this(
    output_name = glue::glue("INS_expression_vs_stress_unfiltered_BMIM.xlsx"),
    output_extension = ".xlsx",
