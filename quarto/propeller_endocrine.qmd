...
---
title: "Endocrine cell proportions"
date: "2024-5-22" 
...
```{r}
endocrine_cell_types <- c("Alpha", "Beta", "Alpha+Beta", "Delta", "Gamma", "Gamma+Epsilon", "Epsilon")
cell_info <- seurat_object[[]] |>
    dplyr::filter(orig.ident != "HPAP-019") |>
    dplyr::filter(!is.na(cell_type)) |>
    dplyr::filter(diabetes_status == "NODM") |>
    dplyr::filter(cell_type %in% endocrine_cell_types)
propeller(
    clusters = cell_info$cell_type, sample = cell_info$orig.ident,
