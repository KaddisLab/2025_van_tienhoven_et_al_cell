...
DimPlot(seurat_object_NODM, group.by = "tosti_cell_type", label = TRUE, cols = cell_type_palette, reduction = "umap", raster = FALSE, shuffle = TRUE) +
    NoLegend() +
...
FeaturePlot(seurat_object_NODM, features = "er_stress_score", reduction = "umap", raster = FALSE) +
...
FeaturePlot(seurat_object_NODM, features = "upr_score", reduction = "umap", raster = FALSE) +
...
DimPlot(seurat_object, group.by = "tosti_cell_type", label = TRUE, cols = cell_type_palette, reduction = "umap", raster = FALSE, shuffle = TRUE) +
    NoLegend() +
    labs(title = "Tosti et al cell type") +
    theme(axis.text.x = element_blank(), axis.text.y = element_blank(), axis.ticks = element_blank())
```
