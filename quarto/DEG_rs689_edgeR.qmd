...
pseudo_bulk_nested <- pseudo_bulk |>
    ...
    mutate(title = paste0("rs689_", cell_type))
```
...
pseudo_bulk_nested <-
    ...
    mutate(grouped_summarized_experiment = map(
        ...
        ~ .x |>
            ...
            keep_abundant(factor_of_interest = rs689_consensus) |>
            ...
            test_differential_abundance(
                ~ 0 + rs689_consensus + tissue_source + technology,
                contrasts = c("rs689_consensusAA - rs689_consensusTT"),
