...
# Save the plot
ggsave("assets/individual_cell_ins_expression.svg", individual_cell_plot, width = 4, height = 4)
knitr::include_graphics("assets/individual_cell_ins_expression.svg")
```


::: {.callout-note icon=false appearance="minimal"}

[<i class="bi bi-filetype-svg"></i> Download Vector Image](assets/individual_cell_ins_expression.svg){download="individual_cell_ins_expression.svg"}
