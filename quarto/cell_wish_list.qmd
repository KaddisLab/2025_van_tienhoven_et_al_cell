...
# seurat_object_all <- glue::glue("{analysis_cache}/data/all_samples_seurat_object.qs") |> load_seurat()
```
...
#| fig-height: 10
#| fig-width: 5
scCustomize::Stacked_VlnPlot(seurat_object, features = cell_type_markers, x_lab_rotate = TRUE, colors_use = custom_palette, group.by = "azimuth_cell_type") & labs(title = "Azimuth")
```
...
#| fig-height: 10
#| fig-width: 5
scCustomize::Stacked_VlnPlot(seurat_object, features = cell_type_markers, x_lab_rotate = TRUE, colors_use = custom_palette, group.by = "gpt_cell_type_sketch") & labs(title = "GPT")
```
...
# snp_info <- getBM(
#     attributes = c(
#         "refsnp_id", "chromosome_name", "chrom_start",
...
Data suggests they in fact used GRCh37: rs3842753 minor allele is C, while in GRCh38
