...
# all_samples_seurat_object<-"/scratch/domeally/DCD.tienhoven_scRNAseq.2024/data/merged_seurat_bp_sketch_integrated_20240327.qs" |> load_seurat()
...
# qs::qsave(seurat_object, "/scratch/domeally/DCD.tienhoven_scRNAseq.2024/data/NODM_seurat_object.qs")
seurat_object <- "/scratch/domeally/DCD.tienhoven_scRNAseq.2024/data/NODM_seurat_object.qs" |> load_seurat()
```
...
![Cell type](cellXgene_annot.png)

![INS expression](cellXgene_INS.png)
